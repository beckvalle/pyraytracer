...
def make_final_scene():
    ...
    # add example of bvh
    boxes = hittables.hittable_list()
    for c in range(5):
        boxes.add(hittables.sphere(point3(float(c-2), 2.0, 2.0), 0.2, orange))
    objects.add(hittables.bvh_node(boxes, _time0=0.0, _time1=1.0))
